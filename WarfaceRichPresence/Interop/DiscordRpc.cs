...
namespace WarfaceRichPresence.Interop
{
	[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
	public delegate void ReadyCallback(ref DiscordUser self);
	...
	[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
	public delegate void RequestCallback(ref DiscordUser requester);
	...
	internal struct RichPresenceStruct
	{
	...
	public class DiscordRpc
	{
		...
		public static extern void Initialize(string applicationId, ref EventHandlers handlers, bool autoRegister = false, string optionalSteamId = null);
